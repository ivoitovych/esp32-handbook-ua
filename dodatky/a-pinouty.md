...
## Типові піни за замовчуванням

| Функція | [[classic]] | [[S3]] | [[C3]] |
|---|---|---|---|
| UART0 TX/RX | 1 / 3 | 43 / 44 | 21 / 20 |
| I²C SDA/SCL | 21 / 22 | 8 / 9 | 5 / 6 |
| SPI MOSI/MISO/SCK/CS | 23/19/18/5 | 11/13/12/10 | 6/2/4/7 |

Це значення за замовчуванням у прикладах, а не апаратна прив'язка:
завдяки матриці GPIO їх можна перепризначити (розділ 04).
