...
Записів доказів: **630**. Звірено дослівно: **116**. Не знайдено: **69**. Джерело не в кеші: **29**. Нема чого звіряти: **388**.

Станом на 2026-08-27 01:28 UTC.


## клас E на твердженні з числом — перевірити — 28
