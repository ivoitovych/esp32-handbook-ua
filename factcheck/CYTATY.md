...
Записів доказів: **861**. Звірено дослівно: **87**. Не знайдено: **61**. Джерело не в кеші: **83**. Нема чого звіряти: **594**.

Станом на 2026-08-27 08:43 UTC.
...
| T-39-093: ESP32 не бачить 5 ГГц мережі | `m2-92-vybirka` | клас E, а в назві число з одиницею |
| T-36-120: SPI діагностика — знизити швидкість до 1 МГц | `m2-92-vybirka` | клас E, а в назві число з одиницею |
| T-E-110: Промислова шина потребує трансивера на 3.3 В | `m2-92-vybirka` | клас E, а в назві число з одиницею |
...
| Діод послідовно для захисту від переполюсовки, падіння 0.3–0.7 В | `m2-95-vybirka` | клас E, а в назві число з одиницею |
...
| Сучасні роутери часто розділяють SSID для діапазонів; ESP32 не бачить 5 ГГц | `m2-97-vybirka` | немає придатних уривків |
| GPIO34 — індекс посилань | `m2-97-vybirka` | немає придатних уривків |
| Літієві батареї не заряджаються нижче 0 °C і втрачають ємність на морозі | `m2-97-vybirka` | немає придатних уривків |
