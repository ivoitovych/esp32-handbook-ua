...
<!-- fc id:T-K13-011 sha:9058fc44 src:kartky/k13-zhyvlennya.md:22 klas:E -->
...
- **Джерело:** USB стандарт (USB 2.0 specification, IEC 61538). Практика підтримується всіма USB-пристроями й таблицею нормалізації напруги у таблиці К13.
- **Дослівно з джерела:**
...
- **Нотатка:** Напруга 5 В ±5% це стандартна норма для USB живлення. Вона служить як точка відліку для діагностики проблем з живленням. Якщо вхідна напруга далеко від цієї норми, то проблема в зовнішньому джерелі, кабелі чи роз'ємі, а не в самій ESP32.
...
- **Нотатка:** Клас E — це порада про схему. Проте, роль біля-чипових конденсаторів згадується у datasheet у контексті придушення шумів. 100 нФ — стандартна номіналу для ВЧ-бачення на вольтажних шинах.
- **Прохід:** m2-31-kartka-k13
