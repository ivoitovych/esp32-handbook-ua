...
примірник розійшовся б із першим.
    ...
    factcheck/tools/intake_f.py <тека прогону>
    factcheck/tools/intake_f.py --self-check      import-and-run smoke test
...
**Generated by `factcheck/tools/intake_f.py --ledger`.** One row per run, appended,
never edited.
