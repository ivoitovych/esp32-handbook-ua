...
## What it does
    ...
    factcheck/tools/entry_points.py --list          what counts as an entry point
    factcheck/tools/entry_points.py --capture DIR   run everything, save the output
    factcheck/tools/entry_points.py --diff A B      compare two captures
    factcheck/tools/entry_points.py --missing       entry points no target covers
