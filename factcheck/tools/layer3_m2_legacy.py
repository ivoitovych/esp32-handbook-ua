#!/usr/bin/env python3
"""Шар 3 — ЗАСТАРІЛИЙ. Уживайте factcheck/tools/layer3.py від М1: він потужніший
...
твердження «40 мА — абсолютна межа». Це шар 2, і скрипт тут безсилий.
    ...
    factcheck/tools/layer3_m2_legacy.py            перевірити все
    factcheck/tools/layer3_m2_legacy.py -v         показати кожен рядок
"""
