...
відібрану за досліджуваною ознакою.
    ...
    factcheck/tools/sample.py E 150          наряд на 150 одиниць класу E
    factcheck/tools/sample.py E 150 --nasinnya 7   інше насіння, явно назване
    factcheck/tools/sample.py --zvit <каталог>     звести вивантаження в міру
"""
...
**Генерується** `factcheck/tools/sample.py`. Насіння **{nasinnya}**, з популяції
...
відсутності, і `factcheck/tools/measure_f.py` відкидає його як «не дивився» ще до
лічби.
...
**Генерується** `factcheck/tools/sample.py --zvit`. Наряд —
...
"""]
    if polagodzheni:
        ...
        r.append("Причина в брифінгу супровідника, не в помічниках: "
                 ...
                 "Див. `factcheck/tools/helper_dumps.py`.\n")
    if bidy:
