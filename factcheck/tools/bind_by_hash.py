...
selected. That refusal is the whole safety of the stage.
    ...
    factcheck/tools/bind_by_hash.py --only pass-40           dry run
    factcheck/tools/bind_by_hash.py --only pass-40 --write   write
    factcheck/tools/bind_by_hash.py --components             sizes only
"""
