...
звідси. Решта лишається в звіті як борг із чесною причиною.
    ...
    factcheck/tools/leads.py <каталог> [<каталог>…]   зібрати factcheck/reports/BRIEF-LEADS.md
"""
...
**Генерується** `factcheck/tools/leads.py`. Це **не** перевірка присуду — присуд
...
KANDYDATY = ROOT / "factcheck" / "work" / "queues" / "leads-candidates.yaml"
