...
|---|---|---|---|
| `F`, джерело видно з тексту | 100 | М1 46, М2 54 | за досяжністю джерела з контейнера |
| `F`, слабкий сигнал | 1353 | **нікому** | ознаки, за якою ділити, немає; чекає на суцільні проходи |
| `E`, оцінка з референтом | ~1399 | обом порівну | 37% від 3780 за випадковою вибіркою; ділиться розділами, бо джерело наперед невідоме |
| `C`, джерело недосяжне звідси | 178 | М2 | у них ширша мережа; для М1 це 403 за побудовою |
...
| Що | Скільки | Кому |
|---|---|---|
| цитата не збігається — супровідник причесав цитату; звірити книгу, потім переписати | 72 | обидва |
| джерело не в кеші — докачати або перевести в `C` з чесною причиною | 70 | М1 |
| надмірний E з числом — «джерела не існує» на твердженні з номіналом | 23 | М2 |

### Поділ класу `E` за файлами — М1 1890, М2 1890
...
**М1 (45):** `00-pro-dovidnyk.md`, `05-elektronika.md`, `06-zhyvlennya.md`, `07-gpio.md`, `08-platy.md`, `10-instrumenty.md`, `12-arduino.md`, `16-boot.md`, `17-esptool.md`, `19-ota.md`, `20-bekap.md`, `22-zberezhennya-stanu.md`, `23-triazh.md`, `24-chuzha-proshyvka.md`, `28-analizator.md`, `29-symptomy.md`, `30-struktura.md`, `31-freertos.md`, `33-peryferiya-kod.md`, `37-onewire.md`, `42-espnow.md`, `44-neznayomyy-modul.md`, `46-dyspleyi.md`, `47-klyuchi.md`, `48-motory.md`, `52-montazh.md`, `53-akum.md`, `56-pasport.md`, `59-proj-monitor.md`, `60-proj-loger.md`, `63-proj-mist.md`, `a-pinouty.md`, `c-komandy.md`, `e-interfeysy.md`, `f-oflayn.md`, `g-glosariy.md`, `h-SOURCES.md`, `k03-pidkl.md`, `k05-proshyvka.md`, `k11-nikoly.md`, `k12-komplekt.md`, `k14-rivni.md`, `regulatory-2026-08.md`, `ua-market-2026-08.md`, `z-pokazhchyk.md`
...
| Твердження | Рядок | Дослівно |
|---|---|---|
| `T-K15-007` | 26 | ☐ · Чим → `write-flash -z 0x0 vyrib-v1.4.bin` |
