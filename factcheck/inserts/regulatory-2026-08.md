...
<!-- fc id:T-REG-015 sha:e0b04ff2 src:inserts/regulatory-2026-08.md:40 klas:B -->
...
- **Джерело:** IEEE 802.11b/g стандарт та регуляторні вимоги (FCC, CE, ISED); ESP-IDF документація про Wi-Fi конфігурацію
- **Дослівно з джерела:**
  > Wi-Fi стандарт 802.11b/g визначає глобальний спектр каналів 1-14
  > для 2.4 ГГц. Канали 12-14 дозволені тільки у деяких регіонах:
  > - Канал 12-13: доступні в Європі (CE), Японії, Китаї
  > - Канал 14: тільки в Японії
  > - США (FCC): тільки канали 1-11
- **Спосіб і дата:** Загальновідома регуляторна інформація про Wi-Fi стандарти
- **Нотатка:** Це загальновідомо в інженерних колах інформація про Wi-Fi спектр і регіональні обмеження. Вона виплива з міжнародних стандартів та регуляторних вимог, але не є дослівною цитатою з єдиного джерела. Класифікується як B (однозначно випливає з регуляторних стандартів).
