...
ті самі одиниці вдруге. Уроки самої посадки — у `ARKHITEKTURA.md`,
...
| `T-17-063` | поділ реєстру відрізав застереження в наступну одиницю (див. `ARKHITEKTURA.md`) |
...
Врятовано з `NARYAD-m2-hvylya3.md` перед його видаленням: у цьому файлі
він був єдиною копією.
