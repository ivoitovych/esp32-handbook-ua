...
Записів доказів: **1337**. Звірено дослівно: **381**. Не знайдено: **95**. Джерело не в кеші: **161**. Нема чого звіряти: **669**.

Станом на 2026-08-28 15:16 UTC.
...
| Просадка нижче 3.0 В — знак проблеми з живленням | `m2-97-vybirka` | доказ класу F — F означає відсутність доказу |
