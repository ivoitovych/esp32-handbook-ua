...
| 4 — обхідні шляхи | те з класу `C`, що закривається через GitHub виробників | |
| 5 — обчислення | арифметика книги, клас `D` | |
| 6 — закриття | усе, що лишилося в `F`, свідомо в `E` або `C` | |
