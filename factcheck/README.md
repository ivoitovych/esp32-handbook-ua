...
Проходи 5 і 7 уже дали нуль виправлень у своїх царинах — арифметика й
API. Це не зупинка всієї роботи, а закриття двох вимірів: далі перевіряти
там нема чого, доки книга не зміниться.
