...
```
factcheck/
  керівні — рішення живуть тут, копій бути не має
    README.md          цей файл: покажчик, стан, обмеження середовища
    METHOD.md          міркування: чому метод такий, англійською, на винос
    ARCHITECTURE.md    три шари перевірки — що кожен ловить і чого не ловить
    SCHEMA.md          формат запису, поля доказу, класи — **нормативний** перелік класів
    DEFECTS.md         каталог родів хиб: ознака, міра, випадок, чим тримається
    TASK-SPEC.md       завдання виконавцеві: блоки, з яких складається кожен наряд
    HELPERS.md      пул: як наряджати дешеву модель і де її межа
    RETROSPECTIVE.md   що хотіли зробити й що вийшло насправді
    MIGRATION.md       переїзд із жаргону в придатну технологію
    REFUTED.md     спростовані формулювання + взірці для пошуку
    SOURCES.md        реєстр джерел: що дістається, що ні
  породжені — переписує інструмент, правити рукою марно
    QUOTES.md          звіт шару 3: чи стоїть цитата за названою адресою
    SPLIT.md           поділ незвіреного між супровідниками
    UNREACHABLE-SOURCES.md  недосяжні джерела на винос
    MEASURE-NO-SIGNAL.md    міра класу E: **випадкова** вибірка, відсоток із похибкою
    MEASURE-UNCHECKED.md    міра класу F: скільки незвіреного справді хибне
    SWEEP-NO-SIGNAL.md      штурм класу E: здобич із вибірки, відібраної рукою
    BOOK-VS-SOURCES.md      книга проти кешу джерел
    BRIEF-SAMPLE.md    наряд на міру — там же насіння добору
    BRIEF-QUOTES.md    наряд на цитати, яких немає в джерелі
    BRIEF-LEADS.md     наряд на здогади про джерело
    RUNS.md            книга прогонів: один рядок на хвилю, з версією наряду
    TRACES.md          сліди прогонів
    TRANSLITERATION.md транслітеровані імена в коді: перелік, що лише коротшає
  історичні — запис завершеної хвилі, числа заморожені
    WAVE-W1.md         хвиля w1: 200 квитків через усю технологію
    TASK-SPEC.md       завдання виконавцеві: блоки, з яких збирають наряд
    TO-VERIFY.md       звіти помічників, які супровідник ще не звірив сам
    LESSONS-M2.md · ARCHITECTURE-M2.md · SOURCES-M2.md · NETWORK-M2.md
    TO-VERIFY-M2.md · REFUTED-M2.md    реєстри другого супровідника
  дані
    evidence/*.yaml    самі докази: джерело, цитата, взірець, клас
    waves/w1/          сирі відповіді помічників хвилі w1
    kartky/ manual/ dodatky/ inserts/       паралельно до книги
```
