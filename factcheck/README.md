...
factcheck/
    ...
    ARKHITEKTURA.md    три шари перевірки — що кожен ловить і чого не ловить
    ...
    PEREVIRYTY.md      звіти помічників, які супровідник ще не звірив сам
    ...
    NARYAD-nedostupni.md  недосяжні джерела на винос
...
**З чого починати читання.** `ARKHITEKTURA.md` — навіщо три шари й чому
