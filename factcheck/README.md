...
factcheck/
  ...
  історичні — запис завершеної хвилі, числа заморожені
    ...
    WORK-ORDER-EXAMPLE.md   зразок зібраного наряду
    TO-VERIFY.md       звіти помічників, які супровідник ще не звірив сам
    LESSONS-M2.md · ARKHITEKTURA-m2.md · DZHERELA-m2.md · MEREZHA-m2.md
    PEREVIRYTY-m2.md · SPROSTOVANE-m2.md    реєстри другого супровідника
  дані
