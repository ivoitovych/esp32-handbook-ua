...
|---|---|---:|---|---:|---|---:|---:|---:|---:|---:|---:|
| proba-100 | `67e8c9a8` | 20260828 | F | 100 | haiku-4.5 | 18 | 9 | 71 | 10 | 4 | 14 |

> `proba-100`: перший прогін під обліком; версію наряду приписано заднім числом — вона та сама, бо SHAPKA не мінялася, змінився лише штамп
| proba-100b | `5856dc32` | ? | F | 100 | haiku-4.5 | 19 | 13 | 64 | 14 | 1 | 9 |

> `proba-100b`: той самий набір, що proba-100, попарно; єдина змінна — наряд англійською. 66/100 вердиктів не змінилися, 34 змінилися в ОБИДВА боки
