...
**Remaining: 45 of 71 files.** Done: 26.

## Foundation

- `factcheck/METHOD.md` — ✓ English
- `factcheck/REPORT.md` — ✓ English
- `factcheck/LESSONS.md` — ✓ English

## Still Ukrainian

- `factcheck/reports/MEASURE-UNCHECKED.md` — 95 %
- `factcheck/reports/REFUTED.md` — 94 %
- `factcheck/reports/MEASURE-NO-SIGNAL.md` — 94 %
- `factcheck/reports/SWEEP-NO-SIGNAL.md` — 93 %
...
- `factcheck/reports/BRIEF-QUOTES.md` — 38 %
- `factcheck/tools/language.py` — 36 %
...
- `factcheck/tools/factcheck.py` — 28 %
