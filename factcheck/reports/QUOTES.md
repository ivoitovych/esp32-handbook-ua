...
Evidence records: **1393**. Checked verbatim: **567**. Not found: **58**. Source not cached: **87**. Nothing to check: **658**.

As of 2026-09-01 21:47 UTC.
...
| T-14-005: Ви прошиваєте його один раз, далі працюєте з | `sweep-14-shvydki-shlyakhy` | 1 sources not in the cache |
| T-14-015: Частина периферії доступна частково. | `sweep-14-shvydki-shlyakhy` | 1 sources not in the cache |
| T-G-054: | прошивка | firmware | | `sweep-g-glosariy` | 1 sources not in the cache |
| T-G-056: | збирання | build | | `sweep-g-glosariy` | 1 sources not in the cache |
| T-G-141: | IDF | IoT Development Framework | | `sweep-g-glosariy` | 1 sources not in the cache |
| T-Z-046: ESP32-C3-MINI-1 — 7, 79, 152, 401 | `sweep-z-pokazhchyk` | 1 sources not in the cache |
| T-Z-047: ESP32-CAM — 14, 80, 82, 279–281 | `sweep-z-pokazhchyk` | 1 sources not in the cache |
| T-Z-051: ESP32-WROOM-32 — 7, 39, 79, 123, 152, 401 | `sweep-z-pokazhchyk` | 1 sources not in the cache |
| T-Z-052: ESP32-WROOM-32D — 79, 152 | `sweep-z-pokazhchyk` | 1 sources not in the cache |
| T-Z-053: ESP32-WROVER — 7, 79, 152 | `sweep-z-pokazhchyk` | 1 sources not in the cache |
...
| T-D-028: `0x9` · Що робити → розділ 32 | `wave-20260901` | 1 sources not in the cache |
| T-D-049: `0x10` · Що робити → розділ 32 | `wave-20260901` | 1 sources not in the cache |
| T-D-051: `rst:0xf` — це **живлення**, не помилка в коді. | `wave-20260901` | 1 sources not in the cache |
| T-E-088: Adafruit за замовчуванням ставить `SPI_MODE0`, частина інших біб | `wave-20260901` | 1 sources not in the cache |
