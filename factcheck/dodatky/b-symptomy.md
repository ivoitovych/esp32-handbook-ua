...
<!-- fc id:T-B-163 sha:6930c5e7 src:dodatky/b-symptomy.md:90 klas:E -->
...
- **Клас:** ⚪ E — поза зовнішньою звіркою — редакційне рішення, порада, рамка викладу
- **Джерело:** Розділ 47 посібника, дані про реле-модулі.
- **Дослівно з джерела:**
...
- **Нотатка:** Клас E — факт про компоненти, які виробник виготовляє, а не про ESP32. Це можна підняти до A, якщо буде наведено паспорт конкретного модуля, але это залежить від партії й виробника.
- **Прохід:** m2-32-symptomy-b

---

<!-- fc id:T-B-164 sha:fb2de766 src:dodatky/b-symptomy.md:90 klas:E -->
...
- **Клас:** ⚪ E — поза зовнішньою звіркою — редакційне рішення, порада, рамка викладу
- **Джерело:** Розділ 47 посібника, практичне рішення для 5-вольтових реле-модулів.
- **Дослівно з джерела:**
...
- **Нотатка:** Клас E — порада про лікування. Базується на контрасту 3.3 В (ESP32) та 5 В (реле-модуль). Це стандартна практика при роботі з різнонапруговими компонентами.
- **Прохід:** m2-32-symptomy-b
