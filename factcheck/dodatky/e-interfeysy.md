...
<!-- fc id:T-E-067 sha:722a12f0 src:dodatky/e-interfeysy.md:44 klas:E -->
...
- **Клас:** ⚪ E — сигналу для звірки в тексті немає — присвоєно механічно, не перевірено
- **Джерело:** Модуль NRF24L01 — загальновідомо; джерела NRF24L01 Datasheet у доступі немає
- **Нотатка:** Таблиця інтерфейсів (додаток e-interfeysy.md) описує NRF24L01 як радіомодуль на 2.4 ГГц. Це технічна специфікація самого модуля.
...
<!-- fc id:T-E-110 sha:dfa3ce29 src:dodatky/e-interfeysy.md:85 klas:E -->
...
- **Нотатка:** Це логічне випливання з того, що ESP32 працює на 3.3 В, але жодне офіційне джерело Espressif не вказує явно вимогу трансивера 3.3 В для промислових шин. Клас E.
