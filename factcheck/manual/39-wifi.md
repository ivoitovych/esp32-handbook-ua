...
<!-- fc id:T-39-093 sha:0e8acf08 src:manual/39-wifi.md:236 klas:E -->
...
- **Клас:** ⚪ E — сигналу для звірки в тексті немає — присвоєно механічно, не перевірено
- **Спосіб і дата:** Пошук 'Wi-Fi', '5 GHz', '802.11' у документації ESP-IDF та датащитах — жодна не називає це найчастішою причиною
- **Нотатка:** Це практична порада від автора на основі досвіду. Жодна офіційна документація не документує це як 'найчастішу причину'. Клас E.
