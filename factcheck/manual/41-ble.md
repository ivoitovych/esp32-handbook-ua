...
<!-- fc id:T-41-044 sha:7d83be34 src:manual/41-ble.md:82 klas:C -->
...
- **Джерело:** ESP32-C3 Technical Specifications, NimBLE vs Bluedroid stack size comparison (standard Espressif documentation)
- **Спосіб і дата:** названо джерело, але цитату не дістав, 2026-08-27
- **Що шукати в джерелі:** ESP32-C3 памяти (SRAM), NimBLE vs Bluedroid размер стека
- **Нотатка:** Источник назван, але не верифікований через дислівний цитат. Потрібно знайти офіційні специфікації ESP32-C3 й документацію NimBLE.
