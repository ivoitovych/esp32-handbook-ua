...
<!-- fc id:T-08-017 sha:92c1af43 src:manual/08-platy.md:20 klas:F -->
...
<!-- fc id:T-08-022 sha:bfdc75f8 src:manual/08-platy.md:35 klas:E -->
...
- **Нотатка:** Це описова характеристика компонента на платі, а не факт про мікросхему ESP32. Клас E: редакційна інформація про анатомію платі.
...
<!-- fc id:T-08-025 sha:661d2705 src:manual/08-platy.md:38 klas:E -->
...
- **Дослівно з джерела:**
  > CP2102, CH340, CH9102 — кожен зі своїм драйвером (розділ 09).
- **Спосіб і дата:** не застосовується
- **Нотатка:** Це посилання на розділ 09, резюме про міст на платі. Редакційна рамка лекції про анатомію платі. Клас E.
- **Прохід:** m2-26-k03-i-platy
...
<!-- fc id:T-08-030 sha:e2b663f4 src:manual/08-platy.md:46 klas:F -->
...
<!-- fc id:T-08-037 sha:bf633b12 src:manual/08-platy.md:61 klas:F -->
...
<!-- fc id:T-08-051 sha:a7d6bade src:manual/08-platy.md:84 klas:F -->
...
<!-- fc id:T-08-059 sha:5c02c121 src:manual/08-platy.md:102 klas:F -->
...
<!-- fc id:T-08-060 sha:fa94dc4d src:manual/08-platy.md:105 klas:C -->
...
- **Джерело:** FTDI datasheet для FT232 та CP2102 datasheet для CP2102
- **Що шукати в джерелі:** Інформація про функціональні параметри яких чипів так чутливі до варіацій виробництво; на скільки офіційний драйвер перевіряє справжність; як клони можуть виявитися непрацездатними при оновленні
- **Нотатка:** Це практична спостереження про масово перероблювані чипи на ринку. Потребує datasheet для FT232RL та CP2102 для поясненння чому клони нестабільні. Також посилання на розділ 09 про драйвери.
- **Прохід:** m2-26-k03-i-platy
