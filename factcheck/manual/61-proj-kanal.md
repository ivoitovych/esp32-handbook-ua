...
- **Джерело:** Специфікація Wi-Fi модулю ESP32 та вимірювання споживання
- **Спосіб і дата:** Таблиця порівняння Wi-Fi vs ESP-NOW у 61-proj-kanal.md
- **Нотатка:** У таблиці порівняння передачі по Wi-Fi та ESP-NOW вказано
«~500 мА·с» як заряд на цикл для Wi-Fi. Число має наближений
характер (позначка ~). Джерело названо як «Специфікація Wi-Fi
модулю», але конкретна посилання не вказана.
