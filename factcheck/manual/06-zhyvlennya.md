...
- **Нотатка:** На відміну від меж `VDD3P3`/`VDD33` у datasheet кристала й модуля (звірено в `m2-06-napruga-mezhi.yaml`), тут ідеться про вхід зовнішнього стабілізатора **плати розробки**, якого немає в жодному з наших джерел — і не може бути, бо плат розробки багато, а стабілізатори на них різні. | Переглянуто 2026-08-27 у розборі 36 надмірних E. Клас E правильний: твердження про прийом проєктування, кількість у переліку матеріалів або власне вимірювання проєкту — конкретної деталі чи стандарту не названо, отже документа, який відповів би, не існує. Число в назві є, але воно номінал у пораді, а не величина з паспорта.
- **Прохід:** m2-21-zhyvlennya-06
