...
- **Розрахунок:**
  R = (U_живлення − U_світлодіода) / I;  (3.3 − 2.0) / 220 = 5.9 мА;  (3.3 − 2.0) / 330 = 3.9 мА
...
- **Спосіб і дата:** Перегляд кешу 2026-08-28: документа немає.
...
2026-08-28. Клас був derived — тобто «першоджерело отримано, твердження випливає». Джерелом стояло «Типова схема управління навантаженням за допомогою N-channel MOSFET» — це опис, а не документ. Отримувати не було чого.
Це означення схеми low-side, а не твердження про названий виріб, тож первинного джерела для нього не існує в принципі. Клас E каже саме це й нічого не стверджує про світ.
Взірець чіпляв 25 одиниць через голе MOSFET; звужено до двох.
- **Прохід:** m2-65-electronics-05
