...
| Знос флешу | вирівнюється | вирівнюється | ні |
...
microSD) читатиме звичайний комп'ютер. Ціною зносу флешу — тому на
вбудованому флеші FAT не варта того, на картці — інша розмова
(розділ 49).
...
- Дві OTA-області означають **подвоєння** місця під застосунок: два по
  1.5 МБ уже майже весь флеш на 4 МБ.
