...
Причина в кожному рядку своя. У classic і S2 проміжок від `0x0` до
`0x1000` зарезервовано під потреби ROM. У наступному поколінні його
прибрали. У найновішому — перші два сектори віддані під ключі апаратного
шифрування флешу, і бутлоадер знову зсунувся.
