...
static void on_recv(const esp_now_recv_info_t *info,
    ...
    xQueueSendFromISR(cherga, data, NULL);
}
esp_now_register_recv_cb(on_recv);
```

::: uvaha
Обробник прийому виконується в контексті задачі Wi-Fi. Правило те саме,
що для ISR (розділ 31): скопіювати дані, покласти в чергу, вийти. Важка
робота там блокує радіостек.
:::
...
**Обмежена кількість peer-ів** — десятки, з окремим лімітом на
зашифровані.
...
- додати датчик означає прописати його MAC у приймачі;
