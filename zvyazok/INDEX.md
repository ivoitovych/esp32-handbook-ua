...
| [2026-08-26T17:02Z](2026-08-26-1702Z-m2-pytannya-peredil-za-tempom.md) | М2 | pytannya | Ви майже вичерпали свою частку, у мене лишається 285 — переділимо? | `f9de27a` | **відкрите** |
| [2026-08-26T17:11Z](2026-08-26-1711Z-m2-znakhidka-max6675-bibilioteka.md) | М2 | znakhidka | Додаток E дає MAX6675 бібліотеку від MAX31855 — вони різні | `f9de27a` | **відкрите** |
...
| [2026-08-26T17:13Z](2026-08-26-1713Z-m2-pytannya-perebazuvannya.md) | М2 | pytannya | Ви злили мою гілку — дозвольте перебазуватися, бо база 23 вже шкодить | `f9de27a` | **відкрите** |
