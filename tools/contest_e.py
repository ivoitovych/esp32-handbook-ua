...
міри є окремий інструмент із випадковою вибіркою — `tools/sample.py`.
...
def tretiy_shar() -> dict[str, str]:
    """Прогнати кандидатів через `tools/layer3.py` і повернути стан кожного.
...
побудовою. Міру дає `tools/sample.py` — випадкова вибірка з насінням,
записаним у наряді.
...
def main() -> int:
    ...
    KANDYDATY.write_text(
        ...
        "# перевірку третім шаром. `tools/layer3.py "
